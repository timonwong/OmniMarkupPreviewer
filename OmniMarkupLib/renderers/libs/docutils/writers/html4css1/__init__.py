...
class Writer(writers.Writer):
    ...
    default_stylesheet_path = os.path.normpath(os.path.join(os.path.dirname(__file__), default_stylesheet))

    default_template = 'template.txt'

    default_template_path = os.path.normpath(os.path.join(os.path.dirname(__file__), default_template))
