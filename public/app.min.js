...
b.filename+"\u2014"+b.dirname;$("#filename").text(b.filename);d.data("timestamp",b.timestamp);d.html(b.html_part);window.App.Options.mathjax_enabled&&MathJax.Hub.Queue(["Typeset",MathJax.Hub,d[0]]);b=f().height-c.height;$("html, body").animate({scrollTop:c.slider_pos+b},"fast")}},complete:c})},h)})()});
