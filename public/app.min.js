...
b.filename+"\u2014"+b.dirname;$("#filename").text(b.filename);d.data("timestamp",b.timestamp);d.html(b.html_part);b=f().height-c.height;$("html, body").animate({scrollTop:c.slider_pos+b},"fast")}},complete:c})},h)})()});
